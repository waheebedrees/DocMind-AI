...
down_revision: str | Sequence[str] | None = "1cb4fe9dc3e5"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.UUID(), nullable=False),
        sa.Column(
            "status", sa.Enum("pending", "processing", "indexed", "failed", name="document_status", native_enum=False, length=32), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.Enum("pending", "running", "completed", "failed", name="evaluation_status", native_enum=False, length=32), nullable=False
        ),
